...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>Attendance Records</b></div>
			<div class="card-body">
					...
					if(Object.keys(data).length > 0){
						...
						Object.keys(data).map(function(k){
							...
							var td = '<td>';
								...
								td += '</td><td>';
								if((record[k].remark_absent != "")&&(record[k].remark_absent != null)){
									td += '<a class="form-check-label remark-lbl" href="remarks/'+record[k].remark_absent+'" target="_blank">Remark</a>';
								}
								td += '</td>';
							tr.append(td)

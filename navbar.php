...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=courses" class="nav-item nav-courses"><span class='icon-field'><i class="fa fa-th-list "></i></span> Department</a>
				...
				<a href="index.php?page=attendance_record" class="nav-item nav-attendance_record"><span class='icon-field'><i class="fa fa-tasks "></i></span> Daily Report</a>
				<a href="index.php?page=attendance_report" class="nav-item nav-attendance_report"><span class='icon-field'><i class="fa fa-tasks "></i></span> Monthly Report</a>
				<a href="index.php?page=attendance_report2" class="nav-item nav-attendance_report2"><span class='icon-field'><i class="fa fa-tasks "></i></span> Summary Report</a>
